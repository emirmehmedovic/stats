  ...
  try {
    ...
    const employee = await prisma.employee.update({
      ...
      data: {
        ...
        ...(validated.workScheduleType && { workScheduleType: validated.workScheduleType }),
        ...(validated.standardStartTime !== undefined && { standardStartTime: validated.standardStartTime || null }),
        ...(validated.standardEndTime !== undefined && { standardEndTime: validated.standardEndTime || null }),
        ...(validated.expectedHoursPerDay !== undefined && { expectedHoursPerDay: validated.expectedHoursPerDay }),
        ...(validated.shiftStartTime1 !== undefined && { shiftStartTime1: validated.shiftStartTime1 || null }),
        ...(validated.shiftEndTime1 !== undefined && { shiftEndTime1: validated.shiftEndTime1 || null }),
        ...(validated.shiftStartTime2 !== undefined && { shiftStartTime2: validated.shiftStartTime2 || null }),
        ...(validated.shiftEndTime2 !== undefined && { shiftEndTime2: validated.shiftEndTime2 || null }),
        ...(validated.shiftRotationStart !== undefined && {
          shiftRotationStart: validated.shiftRotationStart ? dateOnlyToUtc(validated.shiftRotationStart) : null,
        }),
