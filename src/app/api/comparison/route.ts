...
import { startOfDayUtc, endOfDayUtc, formatDateDisplay } from '@/lib/dates';
 ...
 *
 * BEFORE:
 * - N+1 for airlines (60+ queries for loop with findUnique)
 * - N+1 for daily counts (180+ queries for 90 days comparison)
