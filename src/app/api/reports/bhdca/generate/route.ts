...
/**
 * POST /api/reports/bhdca/generate
 * Generiše BHDCA mjesečni izvještaj
 *
 * Body:
 * {
 *   "year": 2025,
 ...
 *   "fileName": "BHDCA_September_2025.xlsx"
 * }
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const scriptPath = path.join(projectRoot, 'scripts', 'generate_bhdca_report.py');
