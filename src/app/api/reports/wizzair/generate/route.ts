...
/**
 * POST /api/reports/wizzair/generate
 * Generiše Wizz Air Daily Performance izvještaj
 *
 * Body:
 * {
 *   "year": 2025,
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
        ...
        return NextResponse.json(
          {
            ...
            details: 'Nema Wizz Air letova u bazi za odabrani mjesec.',
            output: stdout,
          },
          { status: 404 }
        );
      ...
      // Ekstraktovanje putanje do generisanog fajla
