...
/**
 * POST /api/reports/customs/generate
 * Generiše mjesečni statistički izvještaj za carinu
 *
 * Body:
 * {
 *   "year": 2025,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const scriptPath = path.join(projectRoot, 'scripts', 'generate_customs_stats.py');
