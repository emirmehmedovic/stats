 ...
 * Generiše izvještaj za direktora (Januar - odabrani mjesec)
 *
 * Body:
 * {
 *   "year": 2025,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const scriptPath = path.join(projectRoot, 'scripts', 'generate_director_stats.py');
        ...
        return NextResponse.json(
          {
            ...
            details: 'Nema letova u bazi za odabrani period.',
            output: stdout,
          },
          { status: 404 }
        );
