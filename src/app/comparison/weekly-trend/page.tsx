...
export default function WeeklyTrendPage() {
  ...
  const fetchTrendData = async () => {
    ...
    try {
      const response = await fetch('/api/comparison/trends?type=weekly');
    ...
    return (
      ...
      <div className="p-8">
        <div className="flex justify-center py-12">
          <LoadingSpinner text="Učitavam sedmični trend..." />
        </div>
      </div>
      </MainLayout>
  );
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-soft px-6 py-5">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-semibold text-dark-900">Sedmični trend</h1>
          </div>
